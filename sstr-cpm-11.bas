...
823       SEEN(I,J)=0
824       R1=RND(1)
850       IF R1>.8 THEN K3=1
860       IF R1>.95 THEN K3=2
870       IF R1>.98 THEN K3=3
880       K9=K9+K3
980       B3=0
981       IF RND(1)>.96 THEN B3=1
982       B9=B9+B3
1040      GALAXY(I,J)=K3*100+B3*10+INT(RND(1)*8+1)
1041   NEXT J
1042 NEXT I

1043 IF K9>T9 THEN T9=K9+1
1100 IF B9<>0 THEN GOTO 1200
1150 IF GALAXY(Q1,Q2)<200 THEN GALAXY(Q1,Q2)=GALAXY(Q1,Q2)+100:K9=K9+1
1160 B9=1
...
1500 PRINT
1501 K3=INT(GALAXY(Q1,Q2)*.01)
1502 B3=INT(GALAXY(Q1,Q2)*.1)-10*K3
1540 S3=GALAXY(Q1,Q2)-100*K3-10*B3
...
2530 IF S<N-E OR D(7)<0 THEN GOTO 1990 : REM Main Loop
...
4700 IF P<=0 THEN PRINT"ALL PHOTON TORPEDOES EXPENDED.":GOTO 1990 : REM Main Loop
...
5580 IF X<0 OR S=X THEN PRINT"<SHIELDS UNCHANGED>":GOTO 1990 : REM Main Loop
...
5701 IF D0=0 THEN GOTO 1990 : REM Main Loop
5720 D3=0
5721 FOR I=1 TO 8
