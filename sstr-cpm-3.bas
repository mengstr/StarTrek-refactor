...
1280 PRINT
PRINT "ARE YOU READY TO ACCEPT COMMAND ('N' FOR INSTRUCTIONS)";
1300 INPUT I5$
IF LEFT$(I5$,1)="N" OR LEFT$(I5$,1)="n" THEN RUN "TREKINST" ELSE IF LEFT$(I5$,1)="Y" OR LEFT$(I5$,1)="y" THEN 1310 ELSE 1280
1310 PRINT CHR$(26)
1320 Z4=Q1
Z5=Q2
K3=0
...
2020 PRINT
PRINT TAB(10);CHR$(22);"** FATAL ERROR **";CHR$(22)
...
PRINT
2080 FOR I=1 TO 9
IF LEFT$(A$,3)<>MID$(A1$,3*I-2,3)THEN 2160
...
GOTO 4670
4530 K(I,3)=K(I,3)-H
PRINT H;"UNIT HIT ON KLINGON AT SECTOR";K(I,1);CHR$(8);",";
4550 PRINT K(I,2);CHR$(8);"."
IF K(I,3)<=0 THEN PRINT:PRINT CHR$(22);"*** KLINGON DESTROYED ***";CHR$(22):PRINT:GOTO 4580
...
IF Z3=0 THEN 5210
5110 PRINT
PRINT CHR$(22);"*** KLINGON DESTROYED ***";CHR$(22)
PRINT
K3=K3-1
K9=K9-1
IF K9<=0 THEN 6370
...
Z2=Y
GOSUB 8830
IF Z3=0 THEN 4760 REM Use ">B<" to match placed base symbol
...
K(I,3)=K(I,3)/(3+RND(0))
6080 PRINT
PRINT H;"UNIT HIT ON ENTERPRISE FROM SECTOR";K(I,1);CHR$(8);",";K(I,2);CHR$(8);"."
...
6850 PRINT"        STARDATE          ";
PRINT USING"####.#";INT(T*10)*.1
GOTO 7260
6900 PRINT"        CONDITION          ";
IF C$="*RED*" THEN PRINT CHR$(22);"*RED*";CHR$(22) ELSE IF C$="DOCKED" THEN PRINT CHR$(22);"DOCKED";CHR$(22) ELSE PRINT C$
6902 GOTO 7260
...
7970 X$="S"
IF B9<2 THEN X$="":IF B9<1 THEN 8010
