...
333 ISOUTSIDE = 0       : REM Boundary crossing flag
...
3670 IF QUADX>8 EN ISOUTSIDE=1:QUADX=8ECTX=8
3710 IF QUADY<1 THEN ISOUTSIDE=1:QUADY=1ECTY=1
3750 IF QUADY>8 THEN ISOUTSIDE=1:QUADY=8ECTY=8
3790 IF ISOUTSIDE=0 THEN GO 3860
...
8200     INPUT"FINAL COORDINATES (X,Y)";WARP,X
8220     X=X-A
8221     A=C1-WARP
...
8500 IF BASECNT<>0 THEN PRINT"FROM ENTERPRISE TO STARBASE:":WARP=BASEX:X=BASEY:GOTO 8120
...
8596 IF FOUND=0 THEN GOTO 8600
8600 RETURN
