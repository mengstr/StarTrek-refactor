...
334 DIM SEEN(8,8)
335 DIM D(8)
370 DATE=INT(RND(1)*20+20)*100
371 INITDATE=DATE
372 TIMELIMIT=25+INT(RND(1)*10)
373 ISDOCKED=0
374 ENERGY=3000
375 INITENERGY=ENERGY
440 TORPEDOES=10
441 INITTORP=TORPEDOES
...
1280 PRINT
1310 REM
1320 REGIONNUMX=QUADX
1321 REGIONSUFFIX=QUADY
1322 KLINGONCNT=0
1323 BASECNT=0
1324 STARCNT=0
1325 MAPMODE=0
1326 REPAIRMOD=.5*RND(1)
1327 SEEN(REGIONNUMX,REGIONSUFFIX)=GALAXY(REGIONNUMX,REGIONSUFFIX)
1390 IF REGIONNUMX<1 OR REGIONNUMX>8 OR REGIONSUFFIX<1 OR REGIONSUFFIX>8 THEN GOTO 1600
1430 GOSUB 9030
1431 PRINT
...
1500 PRINT
1501 KLINGONCNT=INT(GALAXY(REGIONNUMX,REGIONSUFFIX)*.01)
1502 BASECNT=INT(GALAXY(REGIONNUMX,REGIONSUFFIX)*.1)-10*KLINGONCNT
1540 STARCNT=GALAXY(REGIONNUMX,REGIONSUFFIX)-100*KLINGONCNT-10*BASECNT
...
1990 IF SHIELD+ENERGY>10 THEN IF ENERGY>10 OR D(7)=0 THEN GOTO 2060
2020 PRINT
...
2530 IF SHIELD<N-ENERGY OR D(7)<0 THEN GOTO 1990 : REM Main Loop
...
4000 IF D(3)<0 THEN PRINT"LONG RANGE SENSORS ARE INOPERABLE.":GOTO 1990 : REM Main Loop
...
4260 IF D(4)<0 THEN PRINT"PHASERS INOPERATIVE.":GOTO 1990 : REM Main Loop
...
4730 IF D(5)<0 THEN PRINT"PHOTON TUBES ARE NOT OPERATIONAL.":GOTO 1990 : REM Main Loop
...
5530 IF D(7)<0 THEN PRINT"SHIELD CONTROL INOPERABLE.":GOTO 1990 : REM Main Loop
...
5921     GOSUB 8790
5922     PRINT G2$;LEFT$(Z$,25-LEN(G2$));INT(D(I)*100)*.01
5950 NEXT I
5951 PRINT
...
6141     D(R1)=D(R1)-H/SHIELD-.5*RND(1)
6142     GOSUB 8790
...
7290 IF D(8)<0 THEN PRINT"COMPUTER DISABLED.":GOTO 1990 : REM Main Loop
...
8500 IF BASECNT<>0 THEN PRINT"FROM ENTERPRISE TO STARBASE:":W1=B4:X=B5:GOTO 8120
...
8900 Z3=1
8901 RETURN
9030 IF REGIONSUFFIX>4 THEN GOTO 9120
9031 IF REGIONNUMX=1 THEN GOTO 9040
9032 IF REGIONNUMX=2 THEN GOTO 9050
9033 IF REGIONNUMX=3 THEN GOTO 9060
9034 IF REGIONNUMX=4 THEN GOTO 9070
9035 IF REGIONNUMX=5 THEN GOTO 9080
9036 IF REGIONNUMX=6 THEN GOTO 9090
9037 IF REGIONNUMX=7 THEN GOTO 9100
9038 IF REGIONNUMX=8 THEN GOTO 9110
9120 IF REGIONNUMX=1 THEN GOTO 9130
9121 IF REGIONNUMX=2 THEN GOTO 9140
9122 IF REGIONNUMX=3 THEN GOTO 9150
9123 IF REGIONNUMX=4 THEN GOTO 9160
9124 IF REGIONNUMX=5 THEN GOTO 9170
9125 IF REGIONNUMX=6 THEN GOTO 9180
9126 IF REGIONNUMX=7 THEN GOTO 9190
9127 IF REGIONNUMX=8 THEN GOTO 9200
9210 IF MAPMODE=1 THEN RETURN
9211 IF REGIONSUFFIX=1 THEN GOTO 9230
9212 IF REGIONSUFFIX=2 THEN GOTO 9240
9213 IF REGIONSUFFIX=3 THEN GOTO 9250
9214 IF REGIONSUFFIX=4 THEN GOTO 9260
9215 IF REGIONSUFFIX=5 THEN GOTO 9230
9216 IF REGIONSUFFIX=6 THEN GOTO 9240
9217 IF REGIONSUFFIX=7 THEN GOTO 9250
9218 IF REGIONSUFFIX=8 THEN GOTO 9260
9220 RETURN
9230 G2$=G2$+" I"
9231 RETURN
9240 G2$=G2$+" II"
