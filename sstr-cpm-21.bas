...
338 INITDATE = 0        : REM Initial stardate (2000-4000)
339 DATE = 0            : REM Current stardate
340 TIMELIMIT = 0       : REM Mission time limit
341 ISDOCKED = 0        : REM Flag for docked status
342 INITENERGY = 0      : REM Initial energy level
343 ENERGY = 0          : REM Current energy level
344 INITTORP = 0        : REM Initial torpedo count
345 TORPEDOES = 0       : REM Current torpedo count
346 MAXKLINGONSTR = 0   : REM Maximum Klingon strength
347 SHIELD = 0          : REM Shield energy level
348 TOTALBASES = 0      : REM Total starbases in galaxy
349 TOTALKLINGONS = 0   : REM Total Klingons in galaxy
350 Z3 = 0              : REM Flag for object detection at coordinates

400 REM String variables
401 A$ = ""             : REM Temporary string for object symbol
402 NAME$ = ""          : REM Device or region name string
403 C$ = ""             : REM Ship condition (GREEN, YELLOW, RED)
404 SECTORMAP$ = ""     : REM String containing sector map display
405 O1$ = ""            : REM Line output string
406 X$=""               : REM Temporary string for plurals
407 X0$=""              : REM Temporary verb string

499 DEF FND(D)=SQR((KLINGONS(I,KLINGX)-SECTX)^2+(KLINGONS(I,KLINGY)-SECTY)^2) : REM Distance function

500 REM Initialize game variables
...
520 REM Initialize direction lookup vectors
521 FOR I=1 TO 9
