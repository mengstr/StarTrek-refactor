...
1280 PRINT
1281 PRINT "ARE YOU READY TO ACCEPT COMMAND ('N' FOR INSTRUCTIONS)";
1300 INPUT I5$
1301 IF LEFT$(I5$,1)="N" OR LEFT$(I5$,1)="n" THEN RUN "TREKINST" ELSE IF LEFT$(I5$,1)="Y" OR LEFT$(I5$,1)="y" THEN 1310 ELSE 1280
1310 PRINT CHR$(26)
1320 Z4=Q1
1321 Z5=Q2
1322 K3=0
...
2020 PRINT
2021 PRINT TAB(10);CHR$(22);"** FATAL ERROR **";CHR$(22)
...
2880 NEXT I
2881 IF RND(1)>.2 THEN 3070
2910 R1=FNR(1)
2911 IF RND(1)>=.6 THEN 3000
...
3350 PRINT"SECTOR";S1;CHR$(8);",";S2;"DUE TO BAD NAVAGATION"
3351 GOTO 3370
3360 NEXT I
3361 S1=INT(S1)
3362 S2=INT(S2)
...
3980 RETURN
4000 IF D(3)<0 THEN PRINT"LONG RANGE SENSORS ARE INOPERABLE."
4001 GOTO 1990
4030 PRINT"LONG RANGE SCAN FOR QUADRANT";Q1;CHR$(8);",";Q2
4031 PRINT
4040 O1$="-------------------"
4041 PRINT O1$
...
4500 PRINT"SENSORS SHOW NO DAMAGE TO ENEMY AT";K(I,1);CHR$(8);",";K(I,2);CHR$(8);"."
4501 GOTO 4670
4530 K(I,3)=K(I,3)-H
4531 PRINT H;"UNIT HIT ON KLINGON AT SECTOR";K(I,1);CHR$(8);",";
4550 PRINT K(I,2);CHR$(8);"."
4551 IF K(I,3)<=0 THEN PRINT:PRINT CHR$(22);"*** KLINGON DESTROYED ***";CHR$(22):PRINT:GOTO 4580
...
5062 Z2=Y
5063 GOSUB 8830
5064 IF Z3=0 THEN 5210
5110 PRINT
5111 PRINT CHR$(22);"*** KLINGON DESTROYED ***";CHR$(22)
5112 PRINT
5113 K3=K3-1
5114 K9=K9-1
5115 IF K9<=0 THEN 6370
5150 FOR I=1 TO 3
...
5282 Z2=Y
5283 GOSUB 8830
5284 IF Z3=0 THEN 4760 REM Use ">B<" to match placed base symbol
...
5701 IF D0=0 THEN 1990
5720 D3=0
5721 FOR I=1 TO 8
5722 IF D(I)<0 THEN D3=D3+.1
5760 NEXT I
5761 IF D3=0 THEN 1990
5780 PRINT
5781 D3=D3+D4
...
6080 PRINT
6081 PRINT H;"UNIT HIT ON ENTERPRISE FROM SECTOR";K(I,1);CHR$(8);",";K(I,2);CHR$(8);"."
6090 IF S<=0 THEN 6240
6100 PRINT"      <SHIELDS DOWN TO";S;"UNITS>"
6101 IF H<20 THEN 6200
...
6201 RETURN
6220 PRINT
6221 PRINT"IT IS STARDATE";T;CHR$(8);"."
6222 PRINT
6223 GOTO 6270
6240 PRINT
...
6850 PRINT"        STARDATE          ";
6851 PRINT USING"####.#";INT(T*10)*.1
6852 GOTO 7260
6900 PRINT"        CONDITION          ";
6901 IF C$="*RED*" THEN PRINT CHR$(22);"*RED*";CHR$(22) ELSE IF C$="DOCKED" THEN PRINT CHR$(22);"DOCKED";CHR$(22) ELSE PRINT C$
6902 GOTO 7260
6960 PRINT"        QUADRANT           ";Q1;CHR$(8);",";Q2;CHR$(8)
6961 GOTO 7260
7020 PRINT"        SECTOR             ";S1;CHR$(8);",";S2;CHR$(8)
7021 GOTO 7260
7070 PRINT"        PHOTON TORPEDOES  ";
7071 PRINT USING"######";INT(P)
7072 GOTO 7260
7120 PRINT"        TOTAL ENERGY      ";
7121 PRINT USING"######";INT(E+S)
7122 GOTO 7260
7180 PRINT"        SHIELDS           ";
7181 PRINT USING"######";INT(S)
7182 GOTO 7260
7240 PRINT"        KLINGONS REMAINING";
7241 PRINT USING"######";INT(K9)
7260 NEXT I
7261 PRINT O1$
7262 RETURN
7290 IF D(8)<0 THEN PRINT"COMPUTER DISABLED.":GOTO 1990
7320 INPUT"COMPUTER ACTIVE AND AWAITING COMMAND";A
7321 IF A<0 THEN 1990
7350 PRINT
7351 H8=1
...
7543 PRINT
7544 PRINT"       ";
7545 PRINT"COMPUTER RECORD OF GALAXY FOR QUADRANT";Q1;CHR$(8);",";Q2
7546 PRINT
...
7970 X$="S"
7971 IF B9<2 THEN X$="":IF B9<1 THEN 8010
